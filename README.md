...
## This fork removed the ping back to some whatever Chinese Police website I found in the footer code. I also remove the Umami Analytics code since I do not care about stats.
